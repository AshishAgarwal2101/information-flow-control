...
const stringHigh1: SecurityTypeHigh = SecurityWrapper("Private String 1", "H");
...
const concatStr: SecurityTypeHigh = stringHigh1.concat(" ").concat(stringLow2); //concatStr has security level "H"
